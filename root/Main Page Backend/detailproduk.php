                ...
                <section class="container-product row product-detail-section">
                    <div class="product-image-detail col-12 col-sm-12 col-md-6 px-0">
                        <div class="product-image-thumb">
                            <img src="../MAQNAHIJAB/assets/images/gambar_produk/<?php echo $row['gambar_produk']; ?>" alt="sweater-appreal" class="img-fluid">
                        </div>
                    </div>
                        ...
                        <div class="product-desc-content d-flex flex-column">
                            ...
                            <?php if (isset($_SESSION["id_user"])) : ?>
                                ...
                                if (isset($_POST["order"])) {
                                    ...
                                    $con->query("insert into pesanan (id_pesanan, id_produk, id_pemesan, nama_pemesan, nohp_pemesan, email_pemesan, alamat_pemesan, produk_pesanan, gambar_produk_pesanan, qty, harga_pesanan) values ('$id_pesanan', '$id_produk_pesanan', '$id_pemesan', '$nama_pemesan', '$nohp_pemesan', '$email_pemesan', '$alamat_pemesan','$produk_pesanan', '$gambar_produk_pesanan', '$qty_pesanan','$harga_pesanan')");
