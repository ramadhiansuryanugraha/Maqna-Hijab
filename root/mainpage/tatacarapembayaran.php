...
<head>
	...
	<title>Maqna Hijab | Tata Cara Pembayaran</title>
</head>
	...
	<div class="section">
		<div class="container">
			<div class="content-section">
				...
				<div class="content">
					<p>If You're a registered customer, please login by using your email address. For new customer, simply fill in your details to register.</p>
					<br>
					<p>Select a product. Click 'BUY NOW' Button. Please fill form of the product. </p>
					<br>
					<p>Go to the cart, to see your order. Checkout and do your payment in there with BCA, OVO, or GO-PAY. </p>
					<br>
					<p>Confirmation your Payment. Click 'SUBMIT' and your order is done.</p>
				</div>
			</div>
