...
<body>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modal-add">
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                <label for="cpass" class="form-label">Confim Pasword</label>
                                <input type="password" class="form-control" name="cpass" id="password_admin1" required placeholder="Input Password">
                            </div>
                    ...
                    if (isset($_POST['simpan'])) {
                        ...
                        if ($password_admin != $cpass) {
                            ...
                            $query = "INSERT INTO tabel_akun_admin(nama_admin, email_admin, nohp_admin, password_admin)
                            VALUES('".$nama_admin."','".$email_admin."', '".$nohp_admin."', '".$password_admin."')";
                ...
                ?>
                    <tr>
                        ...
                        <td data-label="Action">
                            ...
                            <a id="edit_akun" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editakun" data-id="<?= $result1['id_admin'] ?>" data-name="<?= $result1['nama_admin'] ?>" data-email="<?= $result1['email_admin'] ?>" data-nohp="<?= $result1['nohp_admin'] ?>" data-pass="<?= $result1['password_admin'] ?>">
                                <i class="fa fa-edit"></i> Edit</a>
                            <a href="?del=<?= $result1['id_admin'] ?>" class="btn btn-danger deletebtn" onclick="return confirm('apakah anda yakin mau menghapus data ini?')">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="function/editadminacc.php" method="POST">
                                <div class="modal-body" id="modal-edit">
                                    ...
                                    <div class="form-group">
                                        <label for="nama_admin" class="form-label">Admin Name</label>
                                        <input type="text" class="form-control" name="nama_admin" id="nama_admin" required placeholder=" Input Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="email_admin" class="form-label">Email address</label>
                                        <input type="email" class="form-control" id="email_admin" name="email_admin" required placeholder="Input Email">
                                        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="nohp_admin" class="form-label">Admin Phone Number</label>
                                        <input type="text" class="form-control" name="nohp_admin" id="nohp_admin" required placeholder="Input Phone Number">
                                    </div>
                                    <div class="form-group">
                                        <label for="password_admin" class="form-label">pasword</label>
                                        <input type="password" class="form-control" name="password_admin" id="password_admin" required placeholder="Input Password">
                                    </div>
                                    <div class="form-group">
                                        <label for="cpass" class="form-label">Confim Pasword</label>
                                        <input type="password" class="form-control" name="cpass" id="password_admin" required placeholder="Confirm Password">
                                    </div>
                                </div>
                                <div class="modal-footer">
    ...
    if (isset($_GET['del'])) {
        ...
        mysqli_query($con, "DELETE FROM tabel_akun_admin WHERE id_admin='$_GET[del]'");
