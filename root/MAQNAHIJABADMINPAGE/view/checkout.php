...
<head>
    ...
    <title>Maqna Hijab | Checkout</title>
</head>
                            ...
                            <td>
                                <div class="cart-info">
                                    ...
                                    <div>
                                        ...
                                        <br>
                                        <small>Qty : <?php echo $row["qty"]; ?></small>
                                        <br>
        ...
        <div class="small-container">
                ...
                <div class="col-md-8">
                    <div class="alert alert-info">
                        <p>
                            ...
                            <strong>
                                Pay Your Payment at <br>
                                 BCA(3740912185, A/N Tiara Marshanda Andrian) <br>
                                 GOPAY(081223797503) <br> OVO(081223797503)
                            </strong>
                        </p>
                    </div>
                </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" class="form-control" readonly value="<?php echo $row["warna_pesanan"]; ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
            ...
            <?php
                    if (isset($_POST['checkout'])) {
                        ...
                        $qty = $row["qty"];
                        $warna_pesanan=$row["warna_pesanan"];
                        $harga_pesanan = $row["harga_pesanan"];

                        $direktori = "../assets/bukti_pembayaran/";
                        $bukti_pembayaran = $_FILES['bukti_pembayaran']['name'];
                        move_uploaded_file($_FILES['bukti_pembayaran']['tmp_name'], $direktori . $bukti_pembayaran);
                        $con->query("INSERT INTO tabel_pembayaran(id_pembayaran, id_produk, id_pemesan,  nama_pemesan, email_pemesan, nohp_pemesan, alamat_pemesan, produk_pesanan, gambar_produk_pesanan, qty, warna_pesanan, harga_pesanan, bukti_pembayaran)
                        VALUES('".$id_pembayaran."','".$id_produk_pembayaran."','".$id_pemesan."','".$nama_pemesan."','".$email_pemesan."','".$nohp_pemesan."','".$alamat_pemesan."','".$produk_pesanan."','".$gambar_produk_pesanan."','".$qty."','".$warna_pesanan."','".$harga_pesanan."','".$bukti_pembayaran."')");
                        ...
                        if($hasil){
                            ...
                            echo "<script>alert('Your order is unsuccesfull');</script>";
